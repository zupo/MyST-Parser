...
- **Task lists** utilise the [markdown-it-py tasklists plugin](myst:inv?i=markdown_it#md/plugins), and are applied to Markdown list items starting with `[ ]` or `[x]`.
...
: See [including a file from outside the docs folder](myst:project#howto/include-readme).
